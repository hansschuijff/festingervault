...
class AutoUpdate
{
	...
	function schedule_action()
	{
		if (function_exists('as_has_scheduled_action')) {
			if (false === as_has_scheduled_action(Constants::SLUG . "/autoupdate")) {
				as_schedule_recurring_action(strtotime('1 hour'), 1 * HOUR_IN_SECONDS, Constants::SLUG . "/autoupdate", [], Constants::SLUG, true);
			}
			if (false === as_has_scheduled_action(Constants::SLUG . "/autoupdate/cleanup")) {
				as_schedule_recurring_action(strtotime('1 hour'), 1 * HOUR_IN_SECONDS, Constants::SLUG . "/autoupdate/cleanup", [], Constants::SLUG, true);
			}
		}
	}
}
